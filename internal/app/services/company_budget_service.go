...
type CompanyBudgetServiceInterface interface {
	...
	Update(Id int, companyBudget request.CompanyBudgetUpdateRequest) (models.CompanyBudget, error)
...
func (s *companyBudgetService) Create(companyBudget request.CompanyBudgetRequest) (models.CompanyBudget, error) {
	dataCompanyBudget := models.CompanyBudget{
		...
		CreatedAt: companyBudget.CreatedAt,
		CreatedBy: companyBudget.CreatedBy,
		UpdatedAt: companyBudget.CreatedAt,
	}
...
func (s *companyBudgetService) Update(Id int, companyBudget request.CompanyBudgetUpdateRequest) (models.CompanyBudget, error) {
	...
	dataCompanyBudget := models.CompanyBudget{
		...
		Budget:    companyBudget.Budget,
		Active:    companyBudget.Active,
		UpdatedAt: companyBudget.UpdatedAt,
		UpdatedBy: companyBudget.UpdatedBy,
	}
